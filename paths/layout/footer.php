 <!-- Footer -->
<footer class="footer bg-dark text-white font-small">
...
<div class="col-12">
  ...
  <div class="row mb-5">
    ...
    <div class="col-md-6 mt-md-0 mt-3">
      ...
      <!-- Content -->
      <h5 class="text-uppercase">Corona Archive</h5>
      <p>Awesome Archive</p>
    ...
    <div class="col-md-3 mb-md-0 mb-3 ">
      ...
      <!-- Links -->
      <h5 class="text-uppercase">Imprint</h5>
...
<small class="text-center font-weight-light float-center">
