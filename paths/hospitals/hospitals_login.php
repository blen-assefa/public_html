...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        // Prepare a select statement
            $sql = "SELECT H.hospital_id, H.hospital_username, H.hospital_password FROM Hospital H WHERE H.hospital_username = ?";
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    ...
                    mysqli_stmt_bind_result($stmt, $hospital_id, $hospital_username, $hashed_password);
                    ...
                    if (mysqli_stmt_fetch($stmt)) {
                        if (password_verify($password, $hashed_password)) {
                            ...
                            $_SESSION['huser'] = $hospital_username;
