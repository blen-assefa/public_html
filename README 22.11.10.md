...
- [x] instaltaion guides were very unclear. Now clearly written
- [x] Redoing all the login information because it was giving a lot of errors. Basically, I couldn't login at all.
- [x] Redoing all registration and login because it was not working at all. There is always an issue with the session_starting.
- [x] Registration and Login Errors are very pressistant and thus making the future work very.
...
## Future Updates
- [x] ALL REGISTRATION DONE AGAIN
- [x] ALL REGISTRATION DONE AGAIN
- [x] Finish all the sign up and registartion pages.
- [x] Make all the UI beauitiful and document as much as you can.
- [x] Creating a new QR code generator for specific use
- [x] QR Code successfully stored in the database
- [x] Event creating with specific qr code now avilable
- [x] UI Implementation
- [x] Additional Tests added
- [x] Implement the relation between the visitors and places.
- [x] Password hashing


A. Feature tests: 5.0

B. Own tests (Unit testing): 0.0

C. GUI: 9.0

D. Documentation: 10.0
